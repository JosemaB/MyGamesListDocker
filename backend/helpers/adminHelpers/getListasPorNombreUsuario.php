...
try {
    ...
    if ($datos) {
        ...
        $usuariosQuery = "SELECT u.id_usuario, u.nombre_usuario, l.* FROM usuarios u, listas l where u.id_usuario = l.id_usuario and nombre_usuario like ?";
...
if (isset($error)) {
    ...
    echo json_encode(["success" => true, "listas" => $usuarios]);
}
exit();
